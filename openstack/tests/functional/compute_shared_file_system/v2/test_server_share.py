...
class TestServerShare(ft_base.BaseComputeTest):
    ...
    def create_server_and_share(self):
    ...
    def delete_server_and_share(self):
    ...
    def test_server_share(self):
        ...
        # Wait a shot moment before submitting new request
        time.sleep(5)
